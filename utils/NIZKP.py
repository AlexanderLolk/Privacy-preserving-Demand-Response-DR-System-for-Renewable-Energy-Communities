...
def schnorr_challenge(elements):
...
# schnorr_proof creates the NIZKP of knowledge of the secret key (rewrite)
def schnorr_proof(sec_params, pk, sk, msg=""):
    ...
    c = Bn.from_binary(challenge) % order
    r = (w - c * sk) % order
    return (c, r, W)
